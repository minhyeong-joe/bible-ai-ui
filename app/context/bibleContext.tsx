...
const resolveChapterSpecifier = (specifier: ChapterSpecifier, available: Chapter[]): number | null => {
...
export function BibleProvider({ children }: { children: ReactNode }) {
    ...
    useEffect(() => {
        ...
        const loadBooks = async () => {
            try {
                ...
                console.error(`Error fetching books for version ${versionState}:`, error);
            }
        };
        ...
        const loadChapters = async () => {
            try {
                ...
                if (desiredChapter !== null) {
                    const resolved = resolveChapterSpecifier(desiredChapter, data.chapters);
                    if (resolved !== null) {
                ...
                console.error(`Error fetching chapters for ${versionState}/${bookState}:`, error);
            }
        };
    ...
    useEffect(() => {
        ...
        fetchVerses(versionState, bookState, chapterNumber)
            ...
            .catch((error) => {
                console.error(`Error fetching verses for ${versionState}/${bookState}/${chapterState}:`, error);
                if (isMounted) {
